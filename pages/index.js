	...
	return (
		<div>
			...
			<main className="pt-20">
				<section className="grid grid-cols-12 gap-4 border-b-gray-600 border-b-2 pb-16 mb-16 container mx-auto">
					<div className="col-start-1 col-end-6 row-start-1 row-end-1 grid z-10">
						<h1>
              A podcast about turning pixels into code.
						</h1>
						<p className="text-2xl items-end">
              Explore the hybrid world of UX Engineering with <a href="#">Adekunle Oduye</a> & <a href="#">Kelly Harrop</a> .
				...
				<section className="grid grid-cols-12 gap-4 container mx-auto pb-36">
              ...
              A couple of UX Engineers, navigating the intersection between design, development and everything inbetween.
				...
				<section className="bg-gray-400">
					<div className="container mx-auto flex flex-row pt-24 pb-24 gap-20">
						<div>
              ...
              Get updates when we launch new episodes. We promise not to spam.
							...
							<div className="flex gap-5">
								...
								<div className="flex items-end">
									<button type="submit" className="rounded-sm bg-blue-500 p-4 text-gray-500 hover:bg-blue-600 transition-colors">Subscribe</button>
								</div>
							</div>
						</div>
					</div>
			...
			<footer className="bg-gray-400">
				<div className="container mx-auto grid grid-cols-2 px-2 py-4">
					<div>
